...
import static com.cloudwebrtc.webrtc.SDKConstantsKt.*;
import static com.cloudwebrtc.webrtc.callsdks.utils.AudioRecorderKt.createMicRecorder;
...
public class MethodCallHandlerImpl implements MethodCallHandler, StateProvider {
  ...
  private fun makeAudioRecorder(): AudioRecord {
...
//            .setAudioTrackErrorCallback(audioTrackErrorCallback)
            .setAudioRecorder(createMicRecorder(
                    AUDIO_SOURCE_MIC, SAMPLE_RATE_IN_HZ,
                    CHANNEL_CONFIG, AUDIO_FORMAT
            ) )
...
//            .createAudioDeviceModule();
    ...
    getUserMediaImpl.audioDeviceModule = (JavaAudioDeviceModule) audioDeviceModule;
        ...
        createAppRecorder createAppRecorder  = new createAppRecorder(getActivity());
//
    audioDeviceModule = createAppRecorder.createJavaAudioDevice(null);
//
//
//    getUserMediaImpl.audioDeviceModule = (JavaAudioDeviceModule) audioDeviceModule;
